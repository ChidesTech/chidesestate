export default function Footer(){
    return <footer className="footer bg-dark space-pt">
    <div className="container">
      <div className="row">
        <div className="col-lg-3 col-md-6">
          <div className="footer-contact-info">
            <h5 className="text-primary mb-4">About Chidesestates</h5>
            <p className="text-white mb-4">Chidesestates helped thousands of clients to find the right property for their needs.</p>
            <ul className="list-unstyled mb-0">
              ...
              <li> <b><i className="fas fa-headset"></i></b><span>support@chidesestates.demo</span> </li>
            </ul>
          </div>
        </div>
